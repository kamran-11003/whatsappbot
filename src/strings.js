...
const strings = {
  ...
  en: {
    ...
    noService:
      `⚠️ Sorry, details for this service are not available yet.\n\nPlease choose another service.`,
    ...
    sindhMultiApp:
      `ℹ️ *Note:* Sindh government services are available across multiple apps. ` +
  ...
  ur: {
    ...
    sindhMultiApp:
      `ℹ️ *نوٹ:* سندھ کی سرکاری خدمات متعدد ایپس پر دستیاب ہیں۔ ` +
